                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body text-center">
                            ...
                            <h4 class="text-primary mb-1">{{ isset($bookings) ? $bookings->count() : 0 }}</h4>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body text-center">
                            ...
                            <h4 class="text-warning mb-1">{{ isset($bookings) ? $bookings->where('status', 'pending')->count() : 0 }}</h4>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body text-center">
                            ...
                            <h4 class="text-success mb-1">{{ isset($bookings) ? $bookings->where('status', 'confirmed')->count() : 0 }}</h4>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body text-center">
                            ...
                            <h4 class="text-info mb-1">{{ isset($bookings) ? $bookings->where('status', 'completed')->count() : 0 }}</h4>
                                    ...
                                    <tr class="border-bottom">
                                        <td class="px-4 py-3">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-professional me-3">
                                                    {{ strtoupper(substr($booking->user->name ?? $booking->name, 0, 1)) }}
                                                </div>
                                                <div>
                                                    <div class="fw-semibold text-dark">{{ $booking->user->name ?? $booking->name }}</div>
                                                    <small class="text-muted">
                                                        <i class="fas fa-envelope me-1"></i>{{ $booking->user->email ?? $booking->email }}
                                                    </small>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="py-3">
                                            <span class="badge bg-light text-dark border">
                                                <i class="fas fa-home me-1"></i>{{ $booking->cabana->name }}
                                            </span>
                                        </td>
                                        <td class="py-3">
                                            <div class="fw-medium">{{ \Carbon\Carbon::parse($booking->date_from)->format('M d, Y') }}</div>
                                            <small class="text-muted">{{ \Carbon\Carbon::parse($booking->date_from)->format('l') }}</small>
                                        </td>
                                        <td class="py-3">
                                            <div class="fw-medium">{{ \Carbon\Carbon::parse($booking->date_to)->format('M d, Y') }}</div>
                                            <small class="text-muted">{{ \Carbon\Carbon::parse($booking->date_to)->format('l') }}</small>
                                        </td>
                                        <td class="py-3">
                                            <span class="badge bg-info text-white">
                                                <i class="fas fa-users me-1"></i>{{ $booking->pax }}
                                            </span>
                                        </td>
                                        <td class="py-3">
                                            <div class="fw-bold text-success fs-6">RM {{ number_format($booking->total_price, 2) }}</div>
                                        </td>
                                        <td class="py-3">
                                            @php
                                                $statusConfig = [
