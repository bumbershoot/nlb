            ...
            <div class="col-lg-6 col-xl-4 mb-4">
                <div class="card h-100 border-0 position-relative cabana-card" style="border-radius: 20px; overflow: hidden; box-shadow: 0 15px 35px rgba(0,0,0,0.1); background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                    ...
                    <div class="position-relative" style="height: 280px; overflow: hidden;">
                        <img src="<?php echo e($cabana->image ? (str_starts_with($cabana->image, 'images/') ? asset($cabana->image) : asset('storage/'.$cabana->image)) : 'https://via.placeholder.com/400x280?text=No+Image'); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bookingresort\resources\views/cabanas/index.blade.php ENDPATH**/ ?>