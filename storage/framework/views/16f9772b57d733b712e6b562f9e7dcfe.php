            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-1"><strong>Booking ID:</strong> #<?php echo e($payment->booking->id); ?></p>
                                <p class="mb-1"><strong>Payment Reference:</strong> <?php echo e($payment->reference); ?></p>
                                <p class="mb-1"><strong>Guest Name:</strong> <?php echo e($payment->booking->name); ?></p>
                            </div>
                            <div class="col-md-6">
                                <p class="mb-1"><strong>Amount to Pay:</strong> <span class="fs-4 text-success">RM <?php echo e(number_format($payment->amount, 2)); ?></span></p>
                                <p class="mb-1"><strong>Check-in Date:</strong> <?php echo e(\Carbon\Carbon::parse($payment->booking->date_from)->format('d M Y')); ?></p>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <ol>
                                        ...
                                        <li class="mb-2">
                                            <strong>Payment:</strong> Pay the exact amount of <strong>RM <?php echo e(number_format($payment->amount, 2)); ?></strong> in cash
                                        </li>
                                        <li class="mb-2">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="mb-1"><strong>Cabana:</strong> <?php echo e($payment->booking->cabana->name); ?></p>
                                    <p class="mb-1"><strong>Guests:</strong> <?php echo e($payment->booking->pax); ?> <?php echo e(Str::plural('person', $payment->booking->pax)); ?></p>
                                    <p class="mb-1"><strong>Nights:</strong> <?php echo e(\Carbon\Carbon::parse($payment->booking->date_from)->diffInDays(\Carbon\Carbon::parse($payment->booking->date_to))); ?></p>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-1"><strong>Check-in:</strong> <?php echo e(\Carbon\Carbon::parse($payment->booking->date_from)->format('d M Y')); ?></p>
                                    <p class="mb-1"><strong>Check-out:</strong> <?php echo e(\Carbon\Carbon::parse($payment->booking->date_to)->format('d M Y')); ?></p>
                    ...
                    <div class="text-center">
                        <a href="<?php echo e(route('bookings.show', $payment->booking->id)); ?>" class="btn btn-outline-secondary me-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nurlaman/public_html/resources/views/payments/cash.blade.php ENDPATH**/ ?>