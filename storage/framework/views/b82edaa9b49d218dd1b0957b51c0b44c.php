        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('locations') ? 'active' : ''); ?>" href="<?php echo e(url('/locations')); ?>">
                            <i class="fas fa-map-marker-alt me-1"></i>Locations
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('cabanas*') ? 'active' : ''); ?>" href="<?php echo e(route('cabanas.index')); ?>">
                            <i class="fas fa-home me-1"></i>Cabanas
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('amenities') ? 'active' : ''); ?>" href="<?php echo e(url('/amenities')); ?>">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <?php if(auth()->user()->isAdmin()): ?>
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.bookings.index')); ?>">
                                        <i class="fas fa-calendar-check me-2"></i>All Bookings
                                    </a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.customers.index')); ?>">
                                        <i class="fas fa-users me-2"></i>Customers
                                    </a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.payments.index')); ?>">
                                        <i class="fas fa-credit-card me-2"></i>Payments
                                    </a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.cabanas.index')); ?>">
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="<?php echo e(route('customer.login')); ?>">
                                    <i class="fas fa-sign-in-alt me-2"></i>Customer Login
                                </a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('customer.register')); ?>">
...
<?php /**PATH C:\laragon\www\bookingresort\resources\views/layouts/app.blade.php ENDPATH**/ ?>