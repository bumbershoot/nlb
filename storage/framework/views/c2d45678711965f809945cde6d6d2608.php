...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-7 mb-4">
            <img src="<?php echo e($cabana->image ? (str_starts_with($cabana->image, 'images/') ? asset($cabana->image) : asset('storage/app/public/'.$cabana->image)) : 'https://via.placeholder.com/600x400'); ?>" 
        ...
        <div class="col-lg-5">
            <!-- Cabana Information -->
            <div class="mb-4">
                <h1 class="display-5 fw-bold text-brown mb-3"><?php echo e($cabana->name); ?></h1>
                <p class="text-muted fs-5 mb-3"><?php echo e($cabana->description); ?></p>
                <div class="d-flex align-items-center mb-4">
                    <h3 class="text-primary fw-bold mb-0">RM <?php echo e(number_format($cabana->price_daily, 2)); ?></h3>
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                <div class="card-body p-4">
                    <form action="<?php echo e(route('bookings.store')); ?>" method="POST" id="bookingForm">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="cabana_id" value="<?php echo e($cabana->id); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const dailyRate = <?php echo e($cabana->price_daily); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nurlaman/public_html/resources/views/cabanas/show.blade.php ENDPATH**/ ?>