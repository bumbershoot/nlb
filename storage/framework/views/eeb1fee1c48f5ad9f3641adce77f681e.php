            ...
            <div class="col-lg-6 col-xl-4 mb-4">
                <div class="card h-100 border-0 position-relative cabana-card" style="border-radius: 20px; overflow: hidden; box-shadow: 0 15px 35px rgba(0,0,0,0.1); background: linear-gradient(145deg, #ffffff, #f8f9fa);">
                    ...
                    <div class="position-relative" style="height: 280px; overflow: hidden;">
                        <img src="<?php echo e($cabana->image ? (str_starts_with($cabana->image, 'images/') ? asset($cabana->image) : asset('storage/app/public/'.$cabana->image)) : 'https://via.placeholder.com/400x280?text=No+Image'); ?>" 
                        ...
                        <div class="position-absolute top-0 end-0 m-3">
                            <div class="badge px-3 py-2 price-badge" 
                                ...
                                <i class="fas fa-tag me-1"></i>RM <?php echo e(number_format($cabana->price_daily, 2)); ?>/day
                            </div>
                        </div>
                        ...
                        <div class="position-absolute bottom-0 start-0 m-3">
                            <div class="badge px-3 py-2" 
                                 style="background: rgba(255,255,255,0.9); 
                                        ...
                                        font-weight: 600;
                                        backdrop-filter: blur(10px);">
                                <i class="fas fa-users me-1"></i><?php echo e($cabana->max_pax); ?> guests
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4" style="background: linear-gradient(145deg, #ffffff, #fafbfc);">
                        ...
                        <?php if($cabana->features): ?>
                            <div class="mb-3">
                                <div class="d-flex flex-wrap gap-2">
                                    <?php $__currentLoopData = $cabana->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                                            <i class="<?php echo e($icon); ?> me-1" style="font-size: 0.7rem;"></i>
                                            <?php echo e(str_replace('_', ' ', $feature)); ?>
                        ...
                        <?php if($cabana->allow_overnight && $cabana->price_overnight): ?>
                            <div class="text-center mt-2">
                                <small class="text-muted">
                                    <i class="fas fa-moon me-1"></i>
                                    Overnight: <strong>RM <?php echo e(number_format($cabana->price_overnight, 2)); ?></strong>
                                </small>
                            </div>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nurlaman/public_html/resources/views/cabanas/index.blade.php ENDPATH**/ ?>