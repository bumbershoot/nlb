...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-7 mb-4">
            <img src="<?php echo e($cabana->image ? (str_starts_with($cabana->image, 'images/') ? asset($cabana->image) : asset('storage/'.$cabana->image)) : 'https://via.placeholder.com/600x400'); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bookingresort\resources\views/cabanas/show.blade.php ENDPATH**/ ?>